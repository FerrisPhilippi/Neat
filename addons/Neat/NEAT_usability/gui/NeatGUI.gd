...
var SpeciesList = preload("res://addons/Neat/NEAT_usability/gui/species_list/SpeciesList.tscn")
var GenomeDetail = preload("res://addons/Neat/NEAT_usability/gui/genome_detail/GenomeDetail.tscn")
